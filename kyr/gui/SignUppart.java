        ...
        registerButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (postalCodeField.getText().isEmpty()) {
                    JOptionPane.showMessageDialog(SignUppart.this, "우편번호를 입력하세요.");
                    return; // 회원가입 중단
                }

                if (!isIdAvailable) {
                    JOptionPane.showMessageDialog(SignUppart.this, "아이디 중복 확인을 해주세요.");
                    return; // 회원가입 취소
                }

                if (!passwordsMatch) {
                    JOptionPane.showMessageDialog(SignUppart.this, "비밀번호 중복 확인을 해주세요.");
                    return; // 회원가입 취소
                }

                if (!isEmailAvailable) {
                    JOptionPane.showMessageDialog(SignUppart.this, "이메일 중복 확인을 해주세요.");
                    return; // 회원가입 취소
                }
