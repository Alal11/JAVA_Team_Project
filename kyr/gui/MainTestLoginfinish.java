...
public class MainTestLoginfinish extends JFrame {
    ...
    public MainTestLoginfinish() {
        ...
        // 카트 아이콘 로드
        ImageIcon cartIcon = new ImageIcon(MainTest.class.getResource("/kyr/image/Cartcon.png")); // 카트 아이콘 이미지 로드
        ...
        ImageIcon menuSearchIcon = new ImageIcon(MainTest.class.getResource("/kyr/image/menuserch.png")); // 메뉴 검색 아이콘 이미지 로드
        ...
        /// Myref 아이콘 로드
        ImageIcon myRefIcon = new ImageIcon(MainTest.class.getResource("/kyr/image/Myref.png")); // Myref 아이콘 이미지 로드
        ...
        ImageIcon myPageIcon = new ImageIcon(MainTest.class.getResource("/kyr/image/MyPage.png")); // MyPage 아이콘 이미지 로드
