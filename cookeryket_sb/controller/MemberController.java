...
public class MemberController {
    ...
    public MemberLoginDTO signIn(@RequestBody MemberLoginDTO memberLoginDTO) {
        MemberEntity memberEntity = memberService.memberLogin(memberLoginDTO);
        if (memberEntity == null) {
            return null;
        }
        MemberLoginDTO loginDTO = new MemberLoginDTO();
        loginDTO.setMemberKey(memberEntity.getMemberKey());
        loginDTO.setMemberId(memberEntity.getMemberId());
        loginDTO.setMemberName(memberEntity.getMemberName());
    ...
    public void pwCheck(@RequestBody MemberCheckPwDTO memberCheckPwDTO) {
        memberService.pwCheck(memberCheckPwDTO);
    }
    ...
    // 회원 조회
    @GetMapping("/inquiry")
    public MemberInquiryDTO inquiryMember(@RequestParam("memberKey") Long memberKey){
        MemberInquiryDTO memberInquiryDTO = memberService.inquiryMember(memberKey);
