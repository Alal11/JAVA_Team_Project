...
public class HttpRequestManager {
     ...
     * @return response : String
     */
    public String deleteRequest(String endPoint, String requestBody) {
        String hostUrl = HOST + endPoint;

        return getResponse(hostUrl, "DELETE", requestBody);
    }
    ...
    public String getResponse(String hostUrl, String requestMethod, String requestBody) {
        ...
        try {
            ...
            if (responseCode == 400) {
                ...
                JOptionPane.showMessageDialog(null, errorMessage, "Cookeryket", JOptionPane.ERROR_MESSAGE);
