...
/*
        ...
        /*MemberLoginDTO memberLoginDTO = new MemberLoginDTO(
                ...
                idField.getText(),
                password);
        MemberApi.signup(memberLoginDTO);*/
        ...
        loginButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                } else if (new String(passwordField.getPassword()).isEmpty() || new String(passwordField.getPassword()).equals("비밀번호")) {
                    JOptionPane.showMessageDialog(Login.this, "비밀번호를 입력해주세요.");
                }

                else {
                    MemberLoginDTO loginDto = new MemberLoginDTO(memberKey,usernameField.getText(),new String(passwordField.getPassword()),membername);

                    // MemberApi 클래스를 통해 로그인 시도
